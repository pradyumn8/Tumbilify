            ...
            <div className={`relative overflow-hidden ${aspectClasses[aspectRatio]}`}>
                ...
                {!isLoading && thumbnail?.image_url && (
                    <div className='group relative w-full h-full'>
                        <img src={thumbnail.image_url} alt="thumbnail preview" className='w-full h-full object-cover' />
                ...
                {!isLoading && !thumbnail?.image_url && (
                    <div className='absolute inset-0 m-2 flex flex-col items-center justify-center gap-4 rounded-lg border-2 border-dashed border-white/20 bg-black/25'>
                        ...
                        <ImageIcon className='size-10 text-white/30 opacity-50' />
                        </div>

                        <div>
                            <p>Generate your first Thumbnail</p>
                            <p className='text-xs text-zinc-400'>I'll out the form and click Generate</p>
                        </div>
                    </div>
                )}
            </div>
